...
async function init() {
  ...
  fs.writeFile(
    ...
    err => {
      ...
      console.log(
        `Successfully wrote legacy Auction Registrar address ${auctionRegistrarAddress} to .env.local`
      )
    }
  )
}
